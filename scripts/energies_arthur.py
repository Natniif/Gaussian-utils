#### ENERGIES.PY - This program takes as input two output files FROM THE PROGRAM EXTRACT.PY and shows the energy barriers between them!
#### Usage: in a terminal, type in: python3 energies.py OUTPUT_FILE_1 OUTPUT_FILE_2 and hit ENTER
#### The output_file_1 should refer to the initial structure, while output_file_2 should refer to the final structure
#### You can adjust it to your own specific needs, but if you have any questions, just e-mail artur.hermano@hotmail.com 
####                                                                                                      Manchester, UK, 2022
